...
function Header(props) {
  ...
  return (
    <header className="relative z-10">
      <img
        src="../src/assets/mine/Group10.png"
        alt=""
      ...
      <div
        ...
        id="dev"
      >
        <div className="text-white text-lg font-bold">Dev Jobs</div>
        <div className="flex justify-around ">
          ...
          <label className={`container ml-2 ${darkModeClass}`}>
            <input
              type="checkbox"
              value=""
              class="sr-only peer"
              onClick={toggleTheme}
            />
            <div className="relative  w-8 h-4 cursor-pointer bg-ligthGray peer-focus:outline-none peer-focus:ring-2 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-violete after:border-white-300 after:border after:rounded-full after:h-3 after:w-3 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
          </label>
          <svg
